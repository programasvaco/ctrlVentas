        ...
        <form action="{{ route('proveedores.update', $proveedor) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="domicilio" name="domicilio" value="{{ $proveedor->domicilio }}">
                </div>

                <div class="col-md-6">
                    <label for="saldo" class="form-label">Saldo</label>
                    <input type="number" step="0.01" class="form-control" id="saldo" name="saldo" value="{{ $proveedor->saldo }}" required>
                </div>
